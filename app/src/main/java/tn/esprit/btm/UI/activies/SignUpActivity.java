...
import tn.esprit.btm.UI.Controller.VolleyController;
import tn.esprit.btm.UI.Helpers.CustomJSONObjectRequest;
        ...
        thread = new Thread(){
            ...
            public void run() {
                try {
                    ...
                    Intent login = new Intent(SignUpActivity.this, Log_activity.class);
